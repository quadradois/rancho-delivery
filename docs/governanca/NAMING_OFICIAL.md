...
Definir nomenclatura oficial para reduzir divergencia entre dominio, codigo e operacao.
...
- Dominios, handles ou instancias ja provisionadas externamente podem manter prefixo legado ate migracao controlada.
