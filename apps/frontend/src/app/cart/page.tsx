...
export default function CartPage() {
      ...
      <div className="min-h-screen flex flex-col" style={{ background: 'var(--madeira-fundo)' }}>
        ...
        <main className="flex-1 flex flex-col items-center justify-center p-6">
          <div className="text-center space-y-4 max-w-sm">
            <div className="w-24 h-24 mx-auto rounded-full flex items-center justify-center" style={{ background: 'var(--madeira-media)' }}>
              <svg width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="var(--cinza-couro)" strokeWidth="1.5">
                <path d="M6 2 3 6v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V6l-3-4z"/>
                <line x1="3" y1="6" x2="21" y2="6"/>
                <path d="M16 10a4 4 0 0 1-8 0"/>
              </svg>
            </div>
            <h2 className="font-display text-2xl text-[var(--bege-claro)]">Carrinho Vazio</h2>
            <p className="text-[var(--cinza-couro)]">Adicione itens deliciosos ao seu carrinho para começar seu pedido</p>
  ...
  return (
    <div className="min-h-screen flex flex-col" style={{ background: 'var(--madeira-fundo)' }}>
      ...
      {/* Footer with Summary */}
      <div className="fixed bottom-0 left-0 right-0 p-6 space-y-4" style={{ background: 'var(--madeira-media)', borderTop: '1px solid var(--madeira-clara)' }}>
        <div className="space-y-2">
          ...
          <div className="flex justify-between pt-2" style={{ borderTop: '1px solid var(--madeira-clara)' }}>
            <span className="font-body font-extrabold text-md uppercase text-[var(--bege-claro)]">Total</span>
            <span className="font-display text-xl text-[var(--brasa-quente)]">
